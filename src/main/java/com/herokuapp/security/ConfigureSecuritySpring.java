...
public class ConfigureSecuritySpring extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers(HttpMethod.POST, URL.KHACH_HANG + URL.DAT_HANG)
				.hasAuthority(Quyen.KHACHHANG.getName());
		...
		http.authorizeRequests().antMatchers(URL.NHAN_VIEN + URL.LGIAY_HANG_DMUC).hasAnyAuthority(Quyen.ADMIN.getName());
